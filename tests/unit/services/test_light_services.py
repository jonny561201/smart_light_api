...
class TestLightServices:
    ...
    def test_get_light_groups__should_call_db_for_groups(self, mock_db, mock_tuya, mock_api):
    ...
    def test_get_light_groups__should_set_on_and_brightness_to_default_when_zero_lights_returned(self, mock_db, mock_tuya, mock_api):
    ...
    def test_set_light_groups__should_set_state_of_all_lights_in_group(self, mock_db, mock_tuya, mock_api):
    ...
    def test_create_group__should_return_response_from_repository(self, mock_db, mock_tuya, mock_api):
        request = {'name': 'test'}
        group_id = str(uuid.uuid4())
    ...
    def test_delete_group__should_call_database_method_to_delete(self, mock_db, mock_tuya, mock_api):
        group_id = str(uuid.uuid4())
    ...
    def test_assign_group__should_call_to_assign_new_light(self, mock_db, mock_tuya, mock_api):
    ...
    def test_assign_group__should_delete_unregistered_device(self, mock_db, mock_tuya, mock_api):
        request = {'lightId': 1, 'groupId': str(uuid.uuid4())}
        device = UnregisteredDevices()
        mock_db.return_value.__enter__.return_value.get_unregistered_light_by.return_value = device
